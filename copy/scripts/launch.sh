...
geth --preload "/private-ethereum/scripts/miner.js" --port ${ETH_PORT} --networkid 1234 --datadir=./datadir  --http --http.port ${ETH_HTTP_PORT} --http.addr 54.242.82.108  --rpcapi "eth,net,web3,personal,miner,admin" --http.corsdomain "*" --allow-insecure-unlock --unlock ${adress} --password list.txt --mine 
